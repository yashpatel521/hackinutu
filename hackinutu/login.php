                    ...
                    <div class="row">
                        <div class="col-lg-6 d-none d-lg-flex">
                            <div class="flex-grow-1 bg-login-image"
                                 style="background-image: url(https://hackinutu.com/static/media/hero.6396d600.png);"></div>
                        </div>
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <form class="user" method="post">
                                    ...
                                    <button class="btn btn-warning btn-block text-white btn-user" type="submit"
                                            name="login">Login
                                    </button>
                                    <hr>
                                </form>
